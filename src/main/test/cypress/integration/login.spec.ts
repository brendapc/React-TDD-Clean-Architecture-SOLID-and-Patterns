...
describe('Login', () => {
  ...
  it('should present error if invalid credentials are provided', () => {
    ...
    cy.getByTestId('error-wrap').getByTestId('spinner').should('exist').getByTestId('main-error').should('not.exist').getByTestId('spinner').should('not.exist').getByTestId('main-error').should('contain.text', 'Credenciais inválidas')
  ...
  it('should save access token if valid credentials are provided', () => {
    ...
    cy.getByTestId('submit-button').click()
    cy.getByTestId('error-wrap').getByTestId('spinner').should('exist').getByTestId('main-error').should('not.exist').getByTestId('spinner').should('not.exist')
